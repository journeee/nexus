                ...
                <div className="signup-form-container">
                    <motion.div className="signup-form" initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1.5, delay: 0.2}}>
                        ...
                        <div className="signup-input">
                            ...
                            <input className="signup-input-placeholder" placeholder="Name"/>
                        </div>
                        <div className="signup-input">
                        ...
                        <div className="signup-input">
                            ...
                            <input className="signup-input-placeholder" placeholder="Confirm Password" type={confirmPasswordVisibility}/>
