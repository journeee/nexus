...
function ThreeServices() {
    return (
        <motion.div initial={{ x: "-500px" }}
                    whileInView={{ x: "0" }}
                    transition={{ duration: 3, delay: 0.1 }} className="service-container">
            <motion.div initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 1, delay: 0.1 }} className="services">
            ...
            <motion.div initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 2, delay: 0.1 }} className="services">
            ...
            <motion.div initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 3, delay: 0.1 }} className="services">
